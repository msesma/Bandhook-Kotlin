...
class AlbumPresenterTest {
    ...
    fun setUp() {
        ...
        albumPresenter = AlbumPresenter(albumView, albumInteractor, albumDetailMapper,interactorExecutor)
    }
    ...
    fun testInit() {
        ...
        Mockito.verify(interactorExecutor).execute(albumInteractor.getFun())
    }
